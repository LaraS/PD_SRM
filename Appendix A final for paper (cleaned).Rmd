...
This models performs very well. By adding these constraints, the convergence problem got completely solved since now all models converged. Also, the fit indices perform very well with all underlying models. General conclusions and guidelines can be given can be made:
...
\begin{itemize} 
  ...
  \item Model 3c is the preferred model.  The fit indices perform well with all underlying true models and all models converge.
\end{itemize}
